:py:mod:`cneuromax.fitting.neuroevolution.agent.base`
=====================================================

.. py:module:: cneuromax.fitting.neuroevolution.agent.base
...
.. autoapisummary::
   ...
   cneuromax.fitting.neuroevolution.agent.base.BaseAgentConfig
   cneuromax.fitting.neuroevolution.agent.base.BaseAgent
...
.. py:class:: BaseAgentConfig
   ...
   :param env_transfer: Whether the agent's environment state            (position, velocity, ...) is transferred to its children            if it passes through the selection process.
   :param fit_transfer: Whether the agent's fitness is transferred to            its children if it passes through the selection process.
   :param mem_transfer: Whether the agent's memory (hidden state) is            transferred to its children if it passes through the            selection process.

   .. py:attribute:: env_transfer
      :type: bool
      :value: False

      

   .. py:attribute:: fit_transfer
      :type: bool
      :value: False

      

   .. py:attribute:: mem_transfer
      :type: bool
      :value: False
