# Adapted from https://github.com/courtois-neuromod/video_transformer/blob/main/src/videogpt/vqvae.py
# which is adapted from https://github.com/wilson1yan/VideoGPT/blob/master/videogpt/vqvae.py
import argparse
import math
...
class VQVAE(pl.LightningModule):
    def __init__(
        ...
        self.encoder = Encoder(
            n_hiddens, n_res_layers, downsample, not no_attn
        )
        ...
        self.pre_vq_conv = SamePadConv3d(
            n_hiddens, embedding_dim, kernel_size=1
        )
        self.post_vq_conv = SamePadConv3d(
            embedding_dim, n_hiddens, kernel_size=1
        )
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log(
            "val/commitment_loss", vq_output["commitment_loss"], prog_bar=True
        )
