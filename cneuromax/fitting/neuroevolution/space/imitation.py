...
# from cneuromax.fitting.neuroevolution.agent.singular import BaseAgent
...
#                     self.curr_actor_data_holder.saved_env
#                 )
...
#             self.discriminator.reset()
#         if self.generator.config.env_transfer:
#             self.curr_actor_data_holder.saved_env = self.get_env_state(
#                 self.curr_env
#             )
...
#         curr_gen: An[int, ge(1)],
#     ) -> np.ndarray:
#         self.generator = agents[0][0]
#         self.discriminator = agents[0][1]
