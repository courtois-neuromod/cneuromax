# Adapted from https://github.com/wilson1yan/VideoGPT/blob/master/videogpt/resnet.py
import math
import numpy as np
...
class NormReLU(nn.Module):
    def __init__(self, channels, relu=True):
        super().__init__()
...
class BlockGroup(nn.Module):
    def __init__(self, in_channels, filters, blocks, stride):
        ...
        for _ in range(1, blocks):
            self.blocks.append(ResidualBlock(filters, filters, 1))
